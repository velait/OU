...
```{r single_series_results, fig.width=12, out.height=5, out.width=10}
...
Running times seem to grow linearly as function of sample size (Fig. `r figs("running_times_plot",display="num")`).
